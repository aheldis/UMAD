...
python -u train.py --name raft-sintel --stage sintel --validation sintel --gpus 0 --num_steps 100000 --batch_size 6 --lr 0.000125 --image_size 184 384 --wdecay 0.00001 --gamma=0.85
